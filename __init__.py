"""
geotools: Container package for various geospatial tools.

Contains following submodules:
- angle: some numeric operations on geographic angles or azimuths
- coordtrans: coordinate transformation between different spatial reference systems
